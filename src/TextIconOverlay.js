...
(function () {
    ...
    */
    TextIconOverlay.prototype._buildCssText = function (style) {
        ...
        csstext.push('cursor:pointer; -webkit-user-select: none;user-select: none;color:' + textColor + '; position:absolute; font-size:' +
            textSize + 'px;     background-size: 46px;background-repeat: no-repeat;background-position: center;font-weight:bold;color:#fff;');
        return csstext.join('');
    };
